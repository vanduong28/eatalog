...
/***/ (function(module, exports, __webpack_require__) {
	...
	);var restaurantUi = __webpack_require__(12);
	...
	var restaurant = __webpack_require__(34);
	...
	$(function () {
	  ...
	  $('#sign-up-modal').on('click', function () {
	    $('#signUp-modal').find('input:text, input:password, select, textarea').val('');
	  });
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://morning-mountain-68152.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showRestaurantsTemplate = __webpack_require__(13
	// const helpers = require('./helpers')

	);var getRestaurantsSuccess = function getRestaurantsSuccess(data) {
	  // console.log('getRestaurantsSuccess data is: ', data)
	  var showRestaurantsHtml = showRestaurantsTemplate({ restaurants: data.restaurants });
	  $('.content').html(showRestaurantsHtml);
	  $('#intro').hide();
	};

	var getRestaurantsFailure = function getRestaurantsFailure() {
	  // console.log('get restaurants failure. error is:', error)
	};

	var deleteRestaurantSuccess = function deleteRestaurantSuccess(id) {
	  event.preventDefault
	...
	var hideViewRestaurantsBtn = function hideViewRestaurantsBtn() {
	  // Hide View restaurants modal button initially until user signs in.
	  $('#view-restaurant-btn').hide();
	};

	var showViewRestaurantsBtn = function showViewRestaurantsBtn() {
	  $('#view-restaurant-btn').show();
	};

	var hideAddRestaurantBtn = function hideAddRestaurantBtn() {
	  // Hide View restaurants modal button initially until user signs in.
	  $('#add-restaurant-btn').hide();
	};

	var showAddRestaurantBtn = function showAddRestaurantBtn() {
	  $('#add-restaurant-btn').show();
	};
	...
	module.exports = {
	  ...
	  getRestaurantsFailure: getRestaurantsFailure,
	  deleteRestaurantSuccess: deleteRestaurantSuccess,
	  deleteRestaurantFailure: deleteRestaurantFailure,
	  hideViewRestaurantsBtn: hideViewRestaurantsBtn,
	  showViewRestaurantsBtn: showViewRestaurantsBtn,
	  hideAddRestaurantBtn: hideAddRestaurantBtn,
	  showAddRestaurantBtn: showAddRestaurantBtn,
	  ...
	  updateRestaurantFailure: updateRestaurantFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <tr data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.neighborhood : stack1), depth0))
	    + "</td>\n        <td contenteditable=\"false\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date_dined : stack1), depth0))
	    + "</td>\n        <td contenteditable=\"false\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"\n          data-toggle=\"modal\" data-target=\"#updateRestaurant-modal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <span class=\"glyphicon glyphicon-pencil\"></span>\n          </button>\n          <!-- Update Restaurant Modal -->\n          <div class=\"modal fade\" id=\"updateRestaurant-modal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"update-restaurant-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n            <div class=\"modal-dialog\" role=\"document\">\n              <div class=\"modal-content\">\n                <div class=\"modal-header\">\n                  <button type=\"button\" class=\"close updateclose\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                  <h4 class=\"modal-title\" id=\"update-restaurant-modal-label\">Update</h4>\n                </div>\n                <div class=\"modal-body\">\n                  <form class=\"restaurant-form-update\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                    <div class=\"form-group\">\n                      <input type=\"text\" name=\"restaurant[name]\" id=\"name-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" placeholder=\"Name (required)\" required>\n                      <input type=\"text\" name=\"restaurant[city]\" id=\"city-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.city : stack1), depth0))
	    + "\" placeholder=\"City\">\n                      <input type=\"text\" name=\"restaurant[cuisine]\" id=\"cuisine-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cuisine : stack1), depth0))
	    + "\" placeholder=\"Cuisine\">\n                      <input type=\"text\" name=\"restaurant[neighborhood]\" id=\"neighborhood-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.neighborhood : stack1), depth0))
	    + "\" placeholder=\"Neighborhood\">\n                      <input type=\"date\" name=\"restaurant[date_dined]\" id=\"date_dined-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date_dined : stack1), depth0))
	    + "\" placeholder=\"Date Dined\">\n                      <input type=\"text\" name=\"restaurant[notes]\" id=\"notes-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
	    + "\" placeholder=\"Notes\">\n                      <input type=\"submit\" name=\"submit\" value=\"Update Info\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"submit-update-button\">\n                    </div>\n                  </form>\n                </div>\n              </div>\n            </div>\n          </div>\n        <!-- </td>\n        <td> -->\n          <button class=\"btn btn-default delete-btn\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	  ...
	  return "<div class=\"rest-listing\">\n<table class=\"table table-striped table-hover header-fixed\">\n\n  <thead>\n    <tr>\n      <th>Name</th>\n      <th>City</th>\n      <th>Cuisine</th>\n      <th>Neighborhood</th>\n      <th>Dine Date</th>\n      <th>Notes</th>\n      <th>Actions</th>\n    </tr>\n  </thead>\n\n    <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.restaurants : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </tbody>\n\n</table>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetRestaurants = function onGetRestaurants(event) {
	  ...
	  api.getRestaurants().then(ui.getRestaurantsSuccess).catch(ui.getRestaurantsFailure);
	};
	...
	var onDeleteRestaurant = function onDeleteRestaurant(event) {
	  ...
	  api.deleteRestaurant(restaurantId).then(ui.deleteRestaurantSuccess(restaurantId)).catch(ui.deleteRestaurantFailure);
	};

	var addRestaurant = function addRestaurant(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createRestaurant(data).then(ui.createRestaurantSuccess).then(onGetRestaurants).catch(ui.createRestaurantFailure);
	};
	...
	var onUpdateRestaurant = function onUpdateRestaurant(event) {
	  ...
	  );api.updateRestaurant(updateInfo, id).then(ui.updateRestaurantSuccess).then(onGetRestaurants).catch(ui.updateRestaurantFailure
